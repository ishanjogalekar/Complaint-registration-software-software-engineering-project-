...
import java.sql.*;
public class ViewComplaint1 extends HttpServlet{
    ...
    out.println("<body>");
        try{
                 ...
                 out.println("<tr><th>Name</th><th>Complaint</th><th>Registration No</th><th>Date</th><th>View</th>");  
                 while (rp.next()) 
                   {  
                    ...
                    out.println("<tr><td>" + n + "</td><td>" + nm + "</td><td>" + cn + "</td><td>"+co+"</td><td>"+"</td><td>"+"<a href=\"detailscomplaint.html\"><button type=\"button\" id=\"button\">View</button></a>"+"</td></tr>");   
                   }  
                 con.commit();
                 con.close(); 
                 out.println("</table>"); 
